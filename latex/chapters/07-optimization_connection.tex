\chapter{Connection with Optimization}
...
\begin{lstlisting}[caption={Python implementation of the adaptive damped Newton method}, label={lst:adaptive_damped_newton}]
