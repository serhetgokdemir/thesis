...
\begin{lstlisting}[caption={Python implementation of the bisection method}, label={lst:bisection}]
...
\begin{lstlisting}[caption={Python implementation of the secant method}, label={lst:secant}]
...
\begin{lstlisting}[caption={Python implementation of Newton's method}, label={lst:newton}]
...
\begin{lstlisting}[caption={Python implementation of the damped Newton method}, label={lst:damped_newton}]
def damped_newton(
    f, df, x0,
    tol=1e-8,
    alpha=0.8,
...
\begin{lstlisting}[caption={Core iteration structure of Brent's method}, label={lst:brent}]
for i in range(max_iter):
