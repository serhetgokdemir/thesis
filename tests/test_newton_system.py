...
def test_newton_system_max_iter():
    ...
    assert not result["converged"]
    # uzak bir başlangıç ya iterasyon limitine takılır ya da jacobian'ı tekil hale getirir
    assert result["message"] in ["maximum iterations reached", "jacobian solve failed"]
